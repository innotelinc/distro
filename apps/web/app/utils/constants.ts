...
// Distro: operators can override the default model per deployment via
// VITE_DEFAULT_MODEL (e.g. an OmniRoute model id that is always available
// on their gateway). Falls back to the upstream bolt.diy default.
export const DEFAULT_MODEL =
  ((import.meta.env.VITE_DEFAULT_MODEL as string | undefined)?.trim() as string | undefined) ||
